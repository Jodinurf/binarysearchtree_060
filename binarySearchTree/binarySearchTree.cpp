...
public:
	...
	void insert(string element) //insert a node in the binary search tree
	{
		...
		newNode->info = element; // Assign a value to the data field of the new node
		...
		else if (element > parent->info) // if the value in the data dield of the new node is greater than that of the parent
		{
...
int main()
{
	...
	while (true) {
		cout << "\nMenu" << endl;
		cout << "1. Implement insert operationn" << endl;
